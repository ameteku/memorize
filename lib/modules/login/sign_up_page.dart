...
class SignUpPage extends StatefulWidget {
  ...
  SignUpPage({required this.appState, Key? key}) : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        if (userNameController.text != '' && passwordController.text != '') {
          UserRepo().addUser(username: userNameController.text, password: passwordController.text).then((user) {
            if (user == null) {
              showDialog(
                context: context,
              ...
              setState(() {
                ...
                print("After siging up: ${user.toString()}");
